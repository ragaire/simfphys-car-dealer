...
local function ShowCarDealerMenu()
    ...
    frame:SetTitle("[NOT FINAL DESIGN, PLACEHOLDER UI] Car Dealer")
    frame:SetPos(ScrW() / 2 -400, ScrH())
...
Oh dear... this is an afterthought. Turns out people want to see their cars!!! xD .. my bad !!! :PP 
    ...
    timer.Simple(1, function()
        if IsValid(frame) then
            ...
            viewerframe:SetTitle("SELECTED VEH VIEWER 28/10/23")
		...
		-- lmao someone needs to help me out with this... i just tweak the numbers till shit looks right but brah it depends on car size
            ...
            vehicleList.OnRowSelected = function(_, index, row)
                ...
                if selectedData and selectedData.model then
                    modelPanel:SetModel(selectedData.model)
                end
            end
...
local function OpenGarageMenu()
    ...
    net.Receive("ReceiveOwnedCars", function()
...
hook.Add("PostDrawOpaqueRenderables", "kinfo_cardealer", function()
